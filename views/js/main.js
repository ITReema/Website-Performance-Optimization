...
// add global varibal and chnge querySelectorAll to getElementsByClassName
...
// declarite global varibal and / creates the moving pizzas in layout row and column 
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var rows = window.screen.height / s;
  var pizzasRequired = cols * rows;
  var elem;
